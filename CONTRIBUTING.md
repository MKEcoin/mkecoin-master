...
posted to #MKEcoin-dev on irc.freenode.net).
...
Copyright (c) 2017-2018 The MKcoin Project.
...
The "MKcoin Maintainer Team" is defined in this document as the following users:
- fluffypony
- MKEcoinmooo
- hyc
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to MKcoin code or MKcoin's dependency code or MKcoin's potential/future dependency code or research which successfully implements MKcoin.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the MKcoin Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the MKcoin Maintainer Team.
