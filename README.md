...
Portions Copyright (c) 2014-2019 The MKEcoin Project.   
...
- Our [Vulnerability Response Process](https://github.com/MKEcoin/mkecoin/blob/master/README.md) encourages responsible disclosure
- We are also available via [HackerOne](https://www.mkecoin.io/)

## Research

The [MKEcoin Research Lab](https://www.mkecoin.io/) is an open forum where the community coordinates research into MKEcoin cryptography, protocols, fungibility, analysis, and more. We welcome collaboration and contributions from outside researchers! Because not all Lab work and publications are distributed as traditional preprints or articles, they may be easy to miss if you are conducting literature reviews for your own MKEcoin research. You are encouraged to get in touch with our researchers if you have questions, wish to collaborate, or would like guidance to help avoid unnecessarily duplicating earlier or known work.


- Sarang Noether, Ph.D.: [sarang@getMKEcoin.org](mailto:mke.technology@yahoo.com) or [sarang.noether@protonmail.com](mailto:mke.technology@yahoo.com); 

## Announcements

- You can subscribe to an [announcement listserv](mke.technology@yahoo.com) to get critical announcements from the MKEcoin core team. The announcement list can be very helpful for knowing when software updates are needed.
...
Core development funding and/or some supporting services are also graciously provided by [sponsors](https://www.mkecoin.io/):
...
* If you would like a specific [version/tag](https://www.mkecoin.io/), do a git checkout for that version. eg. 'v0.17.1.0'. If you don't care about the version and just want binaries from master, skip this step:
...
* Gentoo [MKEcoin overlay](https://github.com/MKEcoin/mkecoin.git)
...
For more detailed information see the ['Pruning' entry in the MKEcoinpedia](https://github.com/MKEcoin/mkecoin.git)
